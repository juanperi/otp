...
old_connection_info_result(Socket) ->
    {ok, Info} = ssl:connection_information(Socket, [protocol, cipher_suite]),
    {ok, {proplists:get_value(protocol, Info), proplists:get_value(cipher_suite_set, Info)}}.
connection_info_result(Socket) ->
    {ok, Info} = ssl:connection_information(Socket, [protocol, cipher_suite_set]),
    {ok, {proplists:get_value(protocol, Info), proplists:get_value(cipher_suite_set, Info)}}.
